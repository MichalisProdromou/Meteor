<template>
  ...
  >
    <v-card>
      ...
      <v-card-subtitle>
        <h2 class="text-center subtitle-1">Please fill in the required information</h2>
      </v-card-subtitle>
      <v-card-text>
        <v-form 
          ref="new-season-form"
...
export default {
  ...
  methods: {
    CloseDialog(){
      eventBus.$emit("CloseNewSeasonDialog");
